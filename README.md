...
## 🚀 การติดตั้ง (สำคัญ! เลือกไฟล์ให้ตรงกับ GPU ของคุณ)  อ่านก่อน !!!!

| GPU ของคุณ | ไฟล์ที่ต้องดับเบิลคลิก |
|-----------|----------------------|
| **GPU ทั่วไป** (GTX 1060 / RTX 2060 / 3060 / 4070 / 4080 ฯลฯ) | `windows-install.bat` |
| **RTX 50 Series** (RTX 5050 / 5060 / 5070 / 5080 / 5090) | `windows-install-rtx50-only.bat` |
