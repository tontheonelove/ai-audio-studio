...
## อ่านก่อนติดตั้ง (สำคัญ! เลือกไฟล์ให้ตรงกับ GPU ของคุณ)  !!!!

| GPU ของคุณ | ไฟล์ที่ต้องดับเบิลคลิกตอนติดตั้งเลือกให้ตรง GPU คุณ |
|-----------|----------------------|
| **GPU ทั่วไป** เช่น (GTX 1060 / RTX 2060 / 3060 / 4070 / 4080 ฯลฯ) | `windows-install.bat` |
| **RTX 50 Series** เช่น (RTX 5050 / 5060 / 5070 / 5080 / 5090) | `windows-install-rtx50-only.bat` |

> ⚠️ **เลือกผิดไฟล์ได้ไหม?** → ถ้าเผลอรันผิดไฟล์ โปรแกรมจะติดตั้ง PyTorch ที่ไม่รองรับ GPU ของคุณ
> → จะเจอ error `no kernel image` ตอนใช้งาน → **แก้โดย:** ลบโฟลเดอร์ `backend\venv` ทิ้ง
> แล้วรันไฟล์ที่ "ถูก" ใหม่ → หาย! (ไม่เสียหายอะไร แค่เสียเวลาลงใหม่)
